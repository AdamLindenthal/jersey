...
import org.glassfish.jersey.client.internal.jdkconnector.JdkConnector;
...
public class JdkConnectorProvider implements ConnectorProvider {
     ...
     * <p/>
     * An instance of {@link org.glassfish.jersey.client.internal.jdkconnector.ThreadPoolConfig} is expected.
     */
     ...
     * <p/>
     * HTTP redirection must be enabled by property {@link ClientProperties#FOLLOW_REDIRECTS},
     * otherwise {@code MAX_HEADER_SIZE} is not applied.
     *
     * @see ClientProperties#FOLLOW_REDIRECTS
     * @see org.glassfish.jersey.client.internal.jdkconnector.RedirectException
     */
